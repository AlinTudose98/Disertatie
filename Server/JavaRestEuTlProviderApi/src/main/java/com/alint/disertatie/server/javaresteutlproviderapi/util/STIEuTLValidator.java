...
@Setter
@Log4j2
public class STIEuTLValidator implements Runnable{
    ...
    @Autowired
    public STIEuTLValidator(Environment env, @Qualifier("tlValidationMutex") Monitor mutex, TLValidationJob job, CertificateVerifier certificateVerifier) {
        this.env = env;
        this.mutex = mutex;
        this.job = job;
