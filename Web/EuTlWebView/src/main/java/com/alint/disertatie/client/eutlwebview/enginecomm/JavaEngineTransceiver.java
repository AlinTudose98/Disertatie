package com.alint.disertatie.client.eutlwebview.enginecomm;
...
@Log4j2
public class JavaEngineTransceiver {
    private final DataInputStream in;
    private final DataOutputStream out;

    public JavaEngineTransceiver(InputStream in, OutputStream out) {
