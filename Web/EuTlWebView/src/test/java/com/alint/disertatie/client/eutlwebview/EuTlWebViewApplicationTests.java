...
class EuTlWebViewApplicationTests {
    ...
    void ServerRetrievesWell() throws IOException {
        STIServerRetriever serverRetriever = context.getBean("STIServerRetriever", STIServerRetriever.class);
    ...
    void checkCertificateInfo() throws IOException {
        ...
        STICertificateInfo info = STICertUtils.getCertificateInfo(base64Certificate);
